        ...
        for (var i = 0; i < users.length; i++) {
            if (loginName.value === users[i].userName) {
                if (loginPassword.value === users[i].password) {
                    ...
                    document.getElementById('userlogin').textContent = userNow.userName;
                } else {
...
function createCart(list, i) {
    let listProduct = document.querySelector('.listcarts')
